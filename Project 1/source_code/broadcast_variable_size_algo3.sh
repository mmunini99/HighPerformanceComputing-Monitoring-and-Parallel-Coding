...
# Algorithm n 3 --> 
echo "number_processes,Size,Latency" > ../output/broadcast_var/broadcast_algo3_variable_core.csv
...
do
	...
	do
		...
		echo "$number_processes,$size,$result_broadcast3" >> ../output/broadcast_var/broadcast_algo3_variable_core.csv
	done
done	
#  end algo 3
